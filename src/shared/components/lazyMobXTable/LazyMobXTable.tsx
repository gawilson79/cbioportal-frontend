...
import {
    ShowMoreControls
} from "../showMoreControls/ShowMoreControls";
import {
...
export default class LazyMobXTable<T> extends React.Component<LazyMobXTableProps<T>, {}> {
    ...
    constructor(props:LazyMobXTableProps<T>) {
        ...
        this.getShowMoreControls = this.getShowMoreControls.bind(this);
    ...
    private getShowMore() {
        return (
            <Observer>
                    { this.getShowMoreControls }
            </Observer>
            //<Button bsSize="sm" block onClick={ this.onNewTodo }>Show More</Button> 
        );
    }
